    ...
    <section className="flex flex-col gap-10">
      <header className="flex flex-col gap-6 text-center text-slate-900 dark:text-white sm:text-left">
        ...
        <p className="mx-auto max-w-3xl text-sm text-slate-600 dark:text-white/70 sm:mx-0">
          Every pizza is hand-stretched, stone baked, and finished with house-made oils.
          Choose your vibe below – vegetarian for the green lovers or dial up the heat
          if you dare. Sizes scale flavour and price, so grab what matches your appetite.
        </p>
